...
<jsp:useBean id="sampleHelloProxyid" scope="session" class="cn.lawliex.HelloProxy" />
<%
...
case 10:
        gotMethod = true;
        cn.lawliex.Hello getHello10mtemp = sampleHelloProxyid.getHello();
...
case 13:
        ...
        java.lang.String getName13mtemp = sampleHelloProxyid.getName(ans_1idTemp);
