...
public class HelloServiceLocator extends org.apache.axis.client.Service implements cn.lawliex.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/MyService/services/Hello";
    ...
    public cn.lawliex.Hello getHello() throws javax.xml.rpc.ServiceException {
    ...
    public cn.lawliex.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.lawliex.HelloSoapBindingStub _stub = new cn.lawliex.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.lawliex.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.lawliex.HelloSoapBindingStub _stub = new cn.lawliex.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://lawliex.cn", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://lawliex.cn", "Hello"));
        }
